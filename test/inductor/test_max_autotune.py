...
class TestTuningProcessPool(TestCase):
    ...
    def test_get_device_list_with_affinity_mask(self, device_type):
        env_var_map = {"cuda": "CUDA_VISIBLE_DEVICES", "xpu": "ZE_AFFINITY_MASK"}
        env_var = env_var_map[device_type]
        env_value = "1,3"

        with (
            mock.patch(
                "torch._inductor.autotune_process.get_gpu_type",
